...
(deftest solve-quadratic-equation-test
  (testing "If the function `clj-ml.utils.linear-algebra/solve-quadratic-equation` can solve quadratic equations properly or not"
...
(deftest find-all-possible-solutions-test
  (testing "if the function `clj-ml.utils.linear-algebra/find-all-possible-solutions` finds all possible solutions correctly"
